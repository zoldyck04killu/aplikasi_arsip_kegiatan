...
$html=<<<EOD
    <center> <h1> Data Dokumen </h1> </center>
    <table border="1">
...
$no = 1;
  $sql = $objAdmin->ShowDokument();
	while ($data = $sql->fetch_object()) {
      $pdf->SetX(10);
      $pdf->writeHTMLCell(0, 0, '', '', $html2.''.
            $no.'</td>
            <td>'.$data->dokument_tgl.'</td>
            <td>'.$data->dokument_no_perkara.'</td>
            <td>'.$data->dokument_no_gugatan.'</td>
            <td>'.$data->dokument_odner.'</td>
            <td>'.$data->dokument_id_jenis.'</td>
            <td>'.$data->dokument_status.'</td>
            <td>'.$data->dokument_ket.'
